...
Note: Preferences are saved in Documents folder as a .txt file and can be deleted to re-save new user prefs.
...
class MainWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Out Null Creator v1.3")
        self.setGeometry(100, 100, 400, 780)
        ...
        self.color_box.setGeometry(10, 10, 380, 280)

        color_layout = QtWidgets.QHBoxLayout()
        self.color_box.setLayout(color_layout)

        self.palette = hou.qt.ColorPalette(size=56,columns=4, rows=4)
        self.palette.setGeometry(10, 20, 40, 40)
        ...
        self.group_box.setGeometry(10, 300, 380, 100)
        ...
        self.shape_box.setGeometry(10, 410, 380, 100)

        # Combo Box for Null shapes
        self.comboBox = QtWidgets.QComboBox(self)
        self.comboBox.setGeometry(QtCore.QRect(30, 450, 340, 40))
        ...
        self.check_box.setGeometry(10, 520, 380, 140)
           
        self.check = QtWidgets.QCheckBox("Create Corresponding Object Merge", self)
        self.check.setGeometry(30, 610, 380, 40)
        ...
        self.mergeBox.setGeometry(QtCore.QRect(30, 560, 340, 40))
